...
VINBarcodeScanner.prototype.scan = function(successCallback, errorCallback) {
    ...
    cordova.exec(successCallback, errorCallback, 'VinBarScanner', 'scan', []);
};

//-------------------------------------------------------------------
VINBarcodeScanner.prototype.encode = function(type, data, successCallback, errorCallback, options) {
    if (errorCallback == null) { errorCallback = function() {}}
    ...
    cordova.exec(successCallback, errorCallback, 'VinBarScanner', 'encode', [{"type": type, "data": data, "options": options}]);
};
